/**
 * Screen 1: Welcome to SmartVerses
 */
    ...
    <div className="onboarding-screen">
      <div className="onboarding-split">
        ...
        <div className="onboarding-content">
          <h1 className="onboarding-title">Welcome to SmartVerses</h1>
          <p className="onboarding-body">
            SmartVerses brings AI and intelligent automation into your media
